...
def set_up():
    ...
    pygame.draw.line(w,(0,0,0),(0,170),(550,170))
    pygame.draw.line(w,(0,0,0),(0,140),(550,140))
    #boxes
...
running=True
#rects
stick_box=(450,40,100,100)
crafting_table_block=(290,50,80,80)
crafting_table_box=(280,40,100,100)
